...
# Still, a good exercise in directly translating Djikstras method from
# java into python at least to TRY to understand it. I managed the conversion
# really easily and it worked first go too.
        ...
        while priorityQueue:
            ...
            for bike_i in range(num_bikes):
                if curr_mask & (1 << bike_i) == 0:
                    next_dist_sum = curr_dist_sum + mh_dist(
                        workers[worker_i], bikes[bike_i]
                    )
